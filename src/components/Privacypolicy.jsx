    ...
    <div className="min-h-screen bg-secondary text-primary font-primary pt-32 pb-16 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-primary mb-4 tracking-tight">Privacy Policy</h1>
          <p className="text-primary font-medium text-lg opacity-70">Last updated: January 9, 2025</p>
        </div>

        <div className="space-y-12 p-6 md:p-12">
          <div className="space-y-4">
            <p className="text-lg text-primary leading-relaxed text-center">
              This Privacy Policy describes how suprbaby (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from suprbaby.in (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
            </p>
            <p className="text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-primary tracking-wide text-center pb-4 mb-4">Changes to This Privacy Policy</h2>
            <p className="text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-primary tracking-wide text-center pb-4 mb-4">How We Collect and Use Your Personal Information</h2>
            <p className="text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-primary tracking-wide text-center pb-4 mb-4">What Personal Information We Collect</h2>
            <p className="text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h3 className="text-xl md:text-2xl font-bold text-primary mb-3 text-center">Information We Collect Directly from You</h3>
            <p className="text-lg text-primary leading-relaxed text-center">
              Information that you directly submit to us through our Services may include:
            </p>
            <ul className="list-none space-y-2 text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h3 className="text-xl md:text-2xl font-bold text-primary mb-3 text-center">Information We Collect about Your Usage</h3>
            <p className="text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h3 className="text-xl md:text-2xl font-bold text-primary mb-3 text-center">Information We Obtain from Third Parties</h3>
            <p className="text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-primary tracking-wide text-center pb-4 mb-4">How We Use Your Personal Information</h2>
            <ul className="list-none space-y-6 text-center">
              <li className="text-lg text-primary leading-relaxed text-center">
                <strong className="text-primary block mb-1">Providing Products and Services.</strong> We use your personal information to provide you with the Services in order to perform our contract with you, including to process your payments, fulfill your orders, to send notifications to you related to your account, purchases, returns, exchanges or other transactions, to create, maintain and otherwise manage your account, to arrange for shipping, facilitate any returns and exchanges and other features and functionalities related to your account.
              </li>
              <li className="text-lg text-primary leading-relaxed text-center">
                <strong className="text-primary block mb-1">Marketing and Advertising.</strong> We may use your personal information for marketing and promotional purposes, such as to send marketing, advertising and promotional communications by email, text message or postal mail, and to show you advertisements for products or services.
              </li>
              <li className="text-lg text-primary leading-relaxed text-center">
                <strong className="text-primary block mb-1">Security and Fraud Prevention.</strong> We use your personal information to detect, investigate or take action regarding possible fraudulent, illegal or malicious activity.
              </li>
              <li className="text-lg text-primary leading-relaxed text-center">
                <strong className="text-primary block mb-1">Communicating with You and Service Improvement.</strong> We use your personal information to provide you with customer support and improve our Services.
              </li>
            </ul>
          </div>

          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-primary tracking-wide text-center pb-4 mb-4">Cookies</h2>
            <p className="text-lg text-primary leading-relaxed text-center">
              Like many websites, we use Cookies on our Site. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services.
            </p>
            <p className="text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-primary tracking-wide text-center pb-4 mb-4">Third Party Websites and Links</h2>
            <p className="text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-primary tracking-wide text-center pb-4 mb-4">Children's Data</h2>
            <p className="text-lg text-primary leading-relaxed text-center">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-primary tracking-wide text-center pb-4 mb-4">Security and Retention of Your Information</h2>
            <p className="text-lg text-primary leading-relaxed text-center">
